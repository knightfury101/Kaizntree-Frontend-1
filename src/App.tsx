...
export function App() {
  ...
  const loadAllTransactions = useCallback(async () => {
    setIsLoading(true);
    // transactionsByEmployeeUtils.invalidateData();  This is Bug-7.

    await employeeUtils.fetchAll();
    setIsLoading(false); //This is Bug 5, Part-1 and Part-2.

    await paginatedTransactionsUtils.fetchAll();
  }, [employeeUtils, paginatedTransactionsUtils]); //Removed transactionsByEmployeeUtils
    ...
    <Fragment>
      <main className="MainContainer">
        ...
        <InputSelect<Employee>
          ...
          onChange={async (newValue) => {
            if (newValue === null) {
              ...
              await loadTransactionsByEmployee(newValue.id); //This is Bug-3.
            }
          }}
        />
        ...
        <div className="KaizntreeGrid">
          ...
          {/* This is Bug-6, Part-1 and Part-2. */}
          {transactions !== null &&
